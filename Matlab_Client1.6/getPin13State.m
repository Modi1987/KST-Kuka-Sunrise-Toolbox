function [ state ] = getPin13State( t )
%% This function is used to get the state of the input pin 13
%     on the media flange, of the KUKA iiwa 7 R 800.

%% Syntax:
% [ state ] = getPin13State( t )

%% About:
% This function is used to get the state of the input pin number 13
%  on the media flange, of the KUKA iiwa 7 R 800.
