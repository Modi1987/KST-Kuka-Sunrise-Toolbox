function [ state ] =nonBlocking_movePTPArcYZ_AC(t,theta,c,vel)
%% This non-blocking function is used for moving the endeffector on an arc in the YZ plane, for the KUKA iiwa 7 R 800.

%% Syntax:
% [ state ] =nonBlocking_movePTPArcYZ_AC(t,theta,c,vel)
