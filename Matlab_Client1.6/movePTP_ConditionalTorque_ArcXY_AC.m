function [ state ] =movePTP_ConditionalTorque_ArcXY_AC(t_Kuka,theta,c,VEL,joints_indices,max_torque,min_torque)
%% This function is used for moving the end-effector on an arc in the XY plane, for the KUKA iiwa 7 R 800.
% this motion is interruptible when one or more of the joints-torques exceed the predefined limits

%% Syntax:
% [ state ] =movePTP_ConditionalTorque_ArcXY_AC(t_Kuka,theta,c,VEL,joints_indices,max_torque,min_torque)
