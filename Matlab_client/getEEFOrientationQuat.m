...
%% Arreguments:
% q: is the quaternion descriping the orientation of the end-effector of
% the media flange of the robot.
...
%% Calculate the normalized quatrinion, from the rotation matrix
    quatrinion=r2quat(eef_transform(1:3,1:3));
    daNorm=norm(quatrinion);
    if(daNorm>0)
        quatrinion=quatrinion/daNorm;
    else
        quatrinion=[];
    end
end
