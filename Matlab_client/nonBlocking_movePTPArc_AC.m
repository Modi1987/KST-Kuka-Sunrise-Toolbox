function [ state ] =nonBlocking_movePTPArc_AC(t,theta,c,k,relVel)
%% This non-blocking function is used for moving the endeffector on an arc, for the KUKA iiwa 7 R 800.

%% Syntax
% [ state ] =nonBlocking_movePTPArc(t,theta,c,k,vel)
...
state= nonBlocking_movePTPCirc1OrintationInter( t , f1,f2, relVel);
