function movePTPEllipse_YZ(tKuka,c,ratio,theta,velocity,accel,TefTool)
...
%% Syntax:
% movePTPEllipse_YZ(tKuka,c,ratio,theta,velocity,accel,TefTool)
...
movePTPEllipse(tKuka,c,dir,ratio,theta,velocity,accel,TefTool);
end
